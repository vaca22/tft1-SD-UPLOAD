...
struct upng_s_rgb16b *InitColorR5G6B5();
struct upng_s_rgb18b *InitColorR6G6B6();
struct upng_s_rgb24b *InitColorR8G8B8();
void InitColor(struct upng_s_rgb16b **dst);
void InitColor(struct upng_s_rgb18b **dst);
void InitColor(struct upng_s_rgb24b **dst);
void ResetColor(struct upng_s_rgb16b *dst);
void ResetColor(struct upng_s_rgb18b *dst);
void ResetColor(struct upng_s_rgb24b *dst);
void
upng_rgb24bto18b(struct upng_s_rgb18b *dst, struct upng_s_rgb24b *src); //Converts 24bit-color(r8,g8,b8) into 18bit-color(r6,g6,b6)
void
upng_rgb24bto16b(struct upng_s_rgb16b *dst, struct upng_s_rgb24b *src); //Converts 24bit-color(r8,g8,b8) into 16bit-color(r5,g6,b5)
void upng_rgb18btouint32(uint32_t *dst, struct upng_s_rgb18b *src);
void upng_rgb16btouint32(uint32_t *dst, struct upng_s_rgb16b *src);
